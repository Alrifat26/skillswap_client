...
return ( <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6"> <div className="mx-auto max-w-6xl"> <div className="mb-8 rounded-[40px] border border-slate-800 bg-gradient-to-r from-emerald-600 via-green-500 to-teal-500 p-10 text-white shadow-2xl"> <h1 className="text-5xl font-black">
Secure Payment Checkout </h1>


      <p className="mt-4 text-lg text-green-50">
        Complete your payment and hire
        your selected freelancer instantly.
      </p>
    </div>
